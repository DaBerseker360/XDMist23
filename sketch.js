...
function preload(){
  trex_running = loadAnimation("Run (1).png","Run (2).png","Run (3).png");
  trex_collided = loadAnimation("Dead (10).png");
  
  groundImage = loadImage("BGTile (7).png");
  
  cloudImage = loadImage("cloud.png");
  
  obstacle1 = loadImage("Barrel (1).png");
  obstacle2 = loadImage("Barrel (2).png");
  obstacle3 = loadImage("Box.png");
  obstacle4 = loadImage("Saw.png");
...
function setup() {
 ...
 console.log(message)
 ground = createSprite(200,height-90,600,20);
